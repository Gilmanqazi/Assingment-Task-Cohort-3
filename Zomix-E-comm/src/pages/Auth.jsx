...
const Auth = () => {
  ...
  return (
    <div className="min-h-screen bg-white flex flex-col justify-center items-center p-4 font-sans selection:bg-blue-600 selection:text-white">
      
      {/* MINI AUTH CARD CONTAINER */}
      <div className="w-full max-w-xs sm:max-w-sm bg-white rounded-2xl p-5 sm:p-6 shadow-2xl shadow-black/50 border border-zinc-100 relative overflow-hidden">
        ...
        <div className="flex bg-zinc-100 p-1 rounded-xl mb-4 border border-zinc-200/60">
          <button
            type="button"
        ...
        <form onSubmit={handleSubmit(onSubmit)} className="space-y-3">
          ...
          <div>
            ...
            {/* MINI STRENGTH METER (Register Only) */}
            {!isLoginTab && passwordValue && (
        ...
        <p className="text-center text-[10px] text-zinc-400 mt-4">
          By continuing, you agree to ZOMIX's{' '}
